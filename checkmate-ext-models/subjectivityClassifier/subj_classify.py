...
os.chdir('/content/drive/MyDrive/subjectivity_classifier-master')
_path = os.getcwd()
...
def _get_subj_or_obj_sentences_from_text(text):
    classifier = SubjectivityClassifier(model_filename=os.path.join(_path, 'data/save/subj-39.tf'),
                                        word_filename=os.path.join(_path, 'data/word_embeddings/glove.6B.50d.word2vec.txt'))
